...
namespace OghiVrTools.SnapzoneTighteningWithToolMechanism
{
    ...
    public class TightenWithGrabbableTool : MonoBehaviour
    {
        ...
        private SnapZone toolSnapzoneToCheck;
        ...
        public TightenType TighteningType { get; private set; } = TightenType.Loose;

        public ToolInstallation ToolInstallation { get; private set; } = ToolInstallation.Uninstalled;
